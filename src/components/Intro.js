        ...
        >
          ...
          >
            <h3 className="text-3xl  text-blue-900 font-bold">
              High quality bespoke software solutions for organizations, SMEs
              and institutions
            </h3>
            <div>
              <p className="my-3 text-xl text-gray-600 font-semibold">
                Step into the realm of innovation with E-mage as your guide. Our
                team is well vast in software development and is ready to help
            ...
            <div>
              <p className="my-3 text-xl text-gray-600 font-semibold">
                We take responsibility for building unique software solutions
